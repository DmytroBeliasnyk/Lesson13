...
public class UserService {
    ...
    public void deleteUsers(List<Long> ids) {
        ids.forEach(id -> {
            ...
            user.ifPresent(u -> {
                if (!(AppConfig.ADMIN_LOGIN.equals(u.getLogin()) || AppConfig.MODERATOR_LOGIN.equals(u.getLogin()))) {
    ...
    public void updateLocked(long id) {
        CustomUser cu = findById(id);
        if (!cu.getRole().equals(UserRole.ADMIN))
            cu.setLocked(!cu.isLocked());
